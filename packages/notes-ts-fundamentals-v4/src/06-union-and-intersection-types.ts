...
/**
 * Type alias where we are defining the ty[e Evens as a union of literal types]
 */
type Evens = 2 | 4 | 6 | 8
let evenNumber: Evens = 2 //✔️ Valid
evenNumber = 2 //! 5 is not in the set
...
//* Working with Union Types: includes everything in both sets
...
//* Intersection Types: anything that. is in both sets
